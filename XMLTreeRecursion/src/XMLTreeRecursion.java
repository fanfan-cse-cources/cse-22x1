...
public final class XMLTreeRecursion {
    ...
    private static int tagCount(XMLTree xml, String tag) {
        ...
        if (xml.isTag()) {
            ...
            for (int i = 0; i < xml.numberOfChildren(); i++) {
                numberOfTag += tagCount(xml.child(i), tag);
            }
        }
    ...
    private static void outputAttributes(XMLTree xml, SimpleWriter out) {
        ...
        for (String name : xml.attributeNames()) {
            out.println(name + "=\"" + xml.attributeValue(name) + "\"");
        }
        for (int i = 0; i < xml.numberOfChildren(); i++) {
    ...
    public static void main(String[] args) {
        ...
        out.println();
        final int numberOfSpaces = 10;
        out.print("outputSpaces(" + numberOfSpaces + ", out):");
        outputSpaces(numberOfSpaces, out);

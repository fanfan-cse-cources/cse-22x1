...
public final class NaturalNumberStaticOps {
    ...
    private static void printWithCommas(NaturalNumber n, SimpleWriter out) {
        ...
        NaturalNumber aThousand = new NaturalNumber2(ONE_THOUSAND);

        if (n.compareTo(aThousand) < 0) {
            out.print(n);
        } else {
            int oneth = n.divideBy10();
            int tenth = n.divideBy10();
            int hundredth = n.divideBy10();

            printWithCommas(n, out);
            out.print("," + hundredth + tenth + oneth);

            n.multiplyBy10(hundredth);
            n.multiplyBy10(tenth);
            n.multiplyBy10(oneth);
        }
    }
    ...
    private static String toStringWithCommas(NaturalNumber n) {
        ...
        if (n.compareTo(aThousand) < 0) {
            ...
            string = toStringWithCommas(n);
            string += "," + hundredth + tenth + oneth;

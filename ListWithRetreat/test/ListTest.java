...
public abstract class ListTest {
    ...
    @Test
    public final void testRetreatRightEmptyBefore() {
        /*
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(4, "red", "green",
                "yellow", "blue");
        List<String> list2 = this.createFromArgsRef(3, "red", "green", "yellow",
                "blue");
        /*
         * Call method under test
         */
    ...
    @Test
    public final void testRetreatLeftEmptyAfterOne() {
        /*
         * Set up variables
         */
    ...
    @Test
    public final void testRetreatLeftEmptyAfterMore() {
        /*
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(1, "red", "green",
                "yellow", "blue");
        List<String> list2 = this.createFromArgsRef(0, "red", "green", "yellow",
                "blue");
        /*
         * Call method under test
         */
    ...
    @Test
    public final void testRetreatBothNotEmpty() {
        /*
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(3, "red", "green",
                "yellow", "blue");
        List<String> list2 = this.createFromArgsRef(2, "red", "green", "yellow",
                "blue");
        /*
         * Call method under test
         */
    ...
    @Test
    public final void testRetreatEqualAfter() {
        /*
         * Set up variables
         */

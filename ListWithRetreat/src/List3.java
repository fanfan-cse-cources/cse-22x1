...
public class List3<T> extends ListSecondary<T> {
    ...
    public final void addRightFront(T x) {
        ...
        Node rightFront = left.next;

        newRightFront.data = x;

        newRightFront.previous = left;
        left.next = newRightFront;
        newRightFront.next = rightFront;
        rightFront.previous = newRightFront;
    ...
    public final T removeRightFront() {
        ...
        Node left = this.lastLeft;
        Node oldRightFront = left.next;
        T x = oldRightFront.data;

        left.next = oldRightFront.next;
        oldRightFront.next.previous = left;
